#!/usr/bin/env bash
# 安装 unit-test-generator 到 OpenClaw workspace skills
# 从 skills/unit-test-generator/SKILL.md 读取，添加 OpenClaw frontmatter 后写入

set -euo pipefail

SKILLS_DIR="$(cd "$(dirname "$0")/../../../skills" && pwd)"
SKILL_FILE="${SKILLS_DIR}/unit-test-generator/SKILL.md"
DST_DIR="${HOME}/.openclaw/skills/unit-test-generator"
